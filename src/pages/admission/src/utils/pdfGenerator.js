            ...
            <body>
                ...
                <div class="application-form">
                    ...
                    <div class="signature">
                        ...
                        <div class="signature-item">
                            ${signatureUrl ? (signatureLoaded ? `<img class="signature-img" src="${signatureUrl}" alt="Signature" crossOrigin="anonymous" />` : `<span style="font-size: 9px; color: red; display: block; margin-bottom: 10px;">Signature Not Loaded</span>`) : `<span style="font-size: 9px; color: #999; display: block; margin-bottom: 10px;">Signature Not Uploaded</span>`}
                            <div class="signature-line"></div>
